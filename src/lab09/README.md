...
в целом мы просто берем наработки с 4 лр и работаем с csv файлом

сделаны две вспомогательные функции: read and ensure storage exists
есть валидация
    ...
    def _read_all(self) -> List[dict]:
        ...
        with self.path.open("r", encoding="utf-8") as f:
            ...
            for row_num, row in enumerate(reader, start=2):  # start=2, т.к. строка 1 - заголовок
                # валидация: проверяем, что все поля присутствуют
